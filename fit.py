...
def add_fit_args(parser):
    ...
    args.add_argument('--num-classes', type=int, default=120,  # by gzb: 120 for ntu120, 60 for ntu60
    ...
    args.add_argument('--judge_rot', type=int, default=1,
                      help='the sub dir to restore train logs, record whether use rog in dataloader')
    args.add_argument('--h5_npz', type=int, default=0,
