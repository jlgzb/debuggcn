...
if __name__ == '__main__':
    ...
    skes_path = '../nturgbd_raw/nturgb+d_skeletons/' # used in GPU colony
    ...
    frames_drop_logger = logging.getLogger('frames_drop_120')  # by gzb: get logger which named as 'frames_drop'
